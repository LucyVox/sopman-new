...
{
    public partial class removeraci : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SOPRACIAcc_SOPProcess_SOPTemplateProcessID",
                        column: x => x.SOPTemplateProcessID,
                        principalTable: "SOPProcess",
                        principalColumn: "SOPTemplateProcessID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SOPRACICon_SOPProcess_SOPTemplateProcessID",
                        column: x => x.SOPTemplateProcessID,
                        principalTable: "SOPProcess",
                        principalColumn: "SOPTemplateProcessID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SOPRACIInf_SOPProcess_SOPTemplateProcessID",
                        column: x => x.SOPTemplateProcessID,
                        principalTable: "SOPProcess",
                        principalColumn: "SOPTemplateProcessID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SOPRACIRes_SOPProcess_SOPTemplateProcessID",
                        column: x => x.SOPTemplateProcessID,
                        principalTable: "SOPProcess",
                        principalColumn: "SOPTemplateProcessID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SOPRACIAcc_SOPTemplateProcessID",
                table: "SOPRACIAcc",
                column: "SOPTemplateProcessID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SOPRACICon_SOPTemplateProcessID",
                table: "SOPRACICon",
                column: "SOPTemplateProcessID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SOPRACIInf_SOPTemplateProcessID",
                table: "SOPRACIInf",
                column: "SOPTemplateProcessID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SOPRACIRes_SOPTemplateProcessID",
                table: "SOPRACIRes",
                column: "SOPTemplateProcessID");

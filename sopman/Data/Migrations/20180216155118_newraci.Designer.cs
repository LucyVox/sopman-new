...
namespace sopman.Data.Migrations
{
    ...
    [Migration("20180216155118_newraci")]
    partial class newraci
    {
            ...
            modelBuilder.Entity("sopman.Data.ApplicationDbContext+RACIAccount", b =>
                {
                    ...
                    b.HasIndex("SOPTemplateProcessID");
            ...
            modelBuilder.Entity("sopman.Data.ApplicationDbContext+RACIAccount", b =>
                {
                    ...
                    b.HasOne("sopman.Data.ApplicationDbContext+SOPTemplateProcess", "SOPProcess")
                        .WithMany()
                        .HasForeignKey("SOPTemplateProcessID")
                        .OnDelete(DeleteBehavior.Cascade);
                });

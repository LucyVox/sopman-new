...
namespace sopman.Data.Migrations
{
    ...
    [Migration("20180215130748_MigrateUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sopman.Data.ApplicationDbContext+SecOrder", b =>
                {
                    ...
                    b.Property<int?>("FileUploadSubSecId");

                    b.Property<int?>("MultilineTextSubSecId");

                    b.Property<int?>("SubSecId");

                    b.Property<int?>("TableSubSecId");

                    b.HasKey("SecOrderId");

                    b.HasIndex("FileUploadSubSecId");

                    b.HasIndex("MultilineTextSubSecId");

                    b.HasIndex("SubSecId");

                    b.HasIndex("TableSubSecId");
            ...
            modelBuilder.Entity("sopman.Data.ApplicationDbContext+SecOrder", b =>
                {
                    b.HasOne("sopman.Data.ApplicationDbContext+FileUploadSec", "FileUpload")
                        .WithMany()
                        .HasForeignKey("FileUploadSubSecId");

                    b.HasOne("sopman.Data.ApplicationDbContext+MultilinkTextSec", "MultilineText")
                        .WithMany()
                        .HasForeignKey("MultilineTextSubSecId");

                    b.HasOne("sopman.Data.ApplicationDbContext+SingleLinkTextSec", "SingleLinkTextSec")
                        .WithMany()
                        .HasForeignKey("SubSecId");

                    b.HasOne("sopman.Data.ApplicationDbContext+TableSec", "Table")
                        .WithMany()
                        .HasForeignKey("TableSubSecId");
                });
